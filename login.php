...
<head>
  <meta charset="utf-8" />
  <title>ClientToolbox Dashboard</title>
...
<body>
  ...
  <div id="logo" class="center">
    <img src="include/assets/img/logo.png" alt="logo" class="center" /> 
  </div>
  <!-- END LOGO -->
  <!-- BEGIN LOGIN -->
  <div id="login">
    <!-- BEGIN LOGIN FORM -->
    <form id="loginform" class="form-vertical no-padding no-margin" method="post" action="user_login.php">
      <p class="center">Enter your username and password.</p>
      <p class="center" style="color:#F00"><?php echo $_SESSION['error']; unset($_SESSION['error']);?></p>
      <div class="control-group">
        <div class="controls">
          <div class="input-prepend">
            <span class="add-on"><a href="configure_points_program.html"><i class="icon-cog"></i></a></span><input id="input-username" name="input-username" type="text" placeholder="Username" />
          </div>
        </div>
      </div>
      <div class="control-group">
        <div class="controls">
          <div class="input-prepend">
            <span class="add-on"><i class="icon-lock"></i></span><input id="input-password" name="input-password" type="password" placeholder="Password" />             
          </div>
