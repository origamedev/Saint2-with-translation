						...
						<div class="span12">
							...
							<div class="widget">
								...
								<div class="widget-body">
										<h5><?php echo $lang['edit_dpv_heading'];?></h5>
                                        
		                                       
       <form action="add_earn_per_event.php" class="form-horizontal" method="post">
                              <div class="control-group">
                                 <label class="control-label" for="input1"><?php echo $lang['Amount'].' '.$lang['edit_dpv_label_ending'];?></label>
                                 <div class="controls">
                                    ...
                                    <input type="hidden" name="desc" value="<?php echo $lang['edit_dpv_label'];?>" /> 
