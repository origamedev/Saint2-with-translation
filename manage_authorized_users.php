							...
							<div class="widget">
								...
								$users_list_contents	=	 submit_cURL ($data);
                                            ...
                                            <td><input type="checkbox" class="checkboxes" name="case[]" value="<?php echo $users['user_id'];?>" /></td>
												...
												<td><?php if($users['user_role'] == 'A'){ echo $lang['user_role_A'];} else if($users['user_role'] == 'M'){ echo $lang['user_role_M']; } else if($users['user_role'] == 'S'){ echo $lang['user_role_S'];}else if($users['user_role'] == 'N'){ echo $lang['user_role_N'];}else if($users['user_role'] == 'G') { echo $lang['user_role_G'];} else if($users['user_role'] == 'I'){ echo $lang['user_role_I'];} else if($users['user_role'] == 'K') { echo $lang['user_role_K']; } else if($users['user_role'] == 'P') {echo $lang['user_role_P'];} else if($users['user_role'] == 'F') {echo $lang['user_role_F'];}else if($users['user_role'] == 'C'){echo $lang['user_role_C'];} else if($users['user_role'] == 'O'){ echo $lang['user_role_O'];} ?></td>
												<!--td><button class="btn btn-small btn-info" type="button" onclick="window.location.href='manage_user.html'"><i class="icon-pencil"></i> Edit</button></td>
                                                <td><button class="btn btn-small btn-danger" type="button"><i class="icon-trash"></i> Delete</button></td-->
