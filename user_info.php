...
<div class="row-fluid">
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-wrench"></i><?php echo $lang['user_my_info_header'];?></h4>
                                ...
                                <div class="span12">
                                       ...
                                       <h5><?php echo $lang['label_account_owner'];?></h5>
                              ...
                              <div class="control-group">
                                 ...
                                 <input type="hidden" value="<?php echo $parse_array['response']['account']['account_id'];?>" name="user_name" />
                                 <div class="controls">
                              ...
                              <div class="control-group">
                                  <label class="control-label" for="lang"><?php echo $lang['label_language_select'];?></label>
                                <div class="controls">
				...
				<option value="">Need More? Contact Us.</option>
								 ...
								 <div class="control-group">
                              	<label class="control-label" for="user_timezone"><?php echo $lang['label_timezone'];?></label>
                                <div class="controls">
                              ...
                              <!--div class="control-group">
                                ...
                                <div class="row-fluid">
                                 ...
                                 <button type="button" class="btn btn-info" onclick="submit_form1()"><?php echo $lang['nav_save_changes'];?></button>
                                 <button type="button" class="btn" onClick="resetme1()"><?php echo $lang['nav_cancel'];?></button>
                                 </form>
                              </div>
