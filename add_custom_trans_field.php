...
$data['user_id'] = $GLOBALS['api_user'];
				...
				{
					if(empty($parse_array_fields['response']['account']['fields']['field'][0]))
					{
						
						if(substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_1' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_2' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_3' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_4' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_5' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_6' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_7' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_8' || substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_9') 
						{
							if(substr($parse_array_fields['response']['account']['fields']['field']['name'], 0, -1) == 'custom_field_')
						{
							$num_array[0] = substr($parse_array_fields['response']['account']['fields']['field']['name'], -1);
						}
						else
						{
							$num_array[0] = substr($parse_array_fields['response']['account']['fields']['field']['name'], -2);
						}	
					}
					}
					else
...
header('Location: custom_fields.php#tab_3_2');