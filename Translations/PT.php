...
$lang['Activation']						= "Activação";// As in "the act of activating" or "turning on". Ex: "Date: 2009.01.01. Transaction: Activation."
$lang['Activity']						= "Actividade";  		// Noun: A description, list, or summary of transactions. Ex: "Activity for this account: 20 transactions."
...
$lang['Deducted']						= "Deduzido";			// As in to be removed or subtracted from a sum. Ex: "100 points were deducted from your balance".
$lang['Redeemed_BuyX']				= $lang['Deducted'];
$lang['Employee']						= "Utente";			// As in a person that works for a business or organization.
...
$lang['Recorded_By']					= "Utente"; 		// As in "the user who recorded this transaction or activity."
...
$lang['Reward']							= "Prémio"; 		// As in a thing that can be claimed after certain conditions have been met. Ex: "The reward for having 1000 points is a free widget."
$lang['Rewards']						= "Prémios"; 	// Plural
...
$lang['Transaction']					= "Transacção"; // A unique event like a purchase, redeeming a reward, etc.
$lang['Transactions']					= "Transacções"; // Plural
...
$lang['title_add_reward']				= "Adicionar Prémio para";
$lang['title_add_user']					= "Adicionar Utente de Conta";
$lang['title_amnesia'] 					= "Login ou Palavra-chave esquecidos";
...
$lang['title_edit_reward']				= "Alterar Prémios de";
...
$lang['title_managing_cards']			= "Gestão de Contas de Clientes";
	...
	$lang['importing_transactions']		= "Introdução por Lote de Transacções";
	$lang['transactions_imported']		= "Transacções Introduzidas por Lote";
$lang['title_more_r_and_e_banners'] 	= "Mais Anúncios Refer-and-Earn";
$lang['title_r_and_e_balance']			= "O Seu Saldo de Refer-and-Earn";
$lang['title_report_all_trans']			= "Relatório de Transacções";
...
$lang['title_report_redeem_trans']		= "Relatório de Transacções Redimidas";
$lang['title_report_totals']			= "Relatório de Posição Integrada";
$lang['title_search_result']			= "Resultados de Pesquisa";
$lang['title_trans_del']				= "Transacção Apagada";
$lang['title_trans_rec'] 				= "Transacção Registada";
$lang['title_view_account']				= "Visualizar Conta";

// Side Modules
$lang['side_blog_describe']				= "Para anúncios, sugestões, e opiniões, visite o nosso"; // ... blog
...
$lang['side_support_email_call']		= "Contacte-nos directamente<br>ou ligue para:";
...
$lang['side_points_calc_desc']			= "Uma ferramenta para ajudar a calcular níveis de prémios";
...
$lang['section_account_new']			= "Criar uma Conta Nova";
...
$lang['label_email']					= "Endereço de Email";
$lang['label_email_short']				= "Email";
$lang['label_first_name']				= "Nome Próprio";					// As in "given name". ie: not the one shared by their family.
$lang['label_language_select']			= "Idioma de exibição";	// As in a prompt to the user to select a language for the application
$lang['label_last_name']				= "Apelido";							// As in "surname" or "family name". ie: A name shared by all members of their family.
...
$lang['label_owner_id']					= "Código de Utente do Proprietário";	// A unique login name that identifies the user as the account owner.
$lang['label_password']					= "Palavra-chave";
$lang['label_password_new']				= "Nova Palavra-chave";
$lang['label_password_retype_short']	= "Reintroduza a Palavra-chave";		// A prompt to re-type the password, to ensure that a mistake wasn't made the first time.
$lang['label_password_retype']			= "Reintroduza a Palavra-chave Nova";	// A prompt to re-type the password, to ensure that a mistake wasn't made the first time.
$lang['label_phone']					= "Número de Telefone";
$lang['label_state']					= "Estado / Localidade";
$lang['label_timezone']					= "Fuso horário";
$lang['label_user_id']					= "Utente"; 				// A unique login name that allows an employee of a StickyStreet client to access the program.
...
$lang['nav_deselect_all']				= "De-seleccionar Tudo";	// As in removing any marked option from a list of available ones. Ex: "Click here to deselect all checked campaigns"
...
$lang['nav_re-activate']				= "Reactivar";				// As in "to turn on again", to "make work once more". Ex: "Click here to re-activate this campaign that was on hold."
$lang['nav_record']						= "Registar";				// Verb: As in to record a transaction. Ex: "Click here to record this transaction."
$lang['nav_redeem']						= "Redimir";				// Verb: As in "exchange accumulated units of value for a defined reward". Ex: "I want to redeem my 100 points for a free massage."
...
$lang['nav_select_all']					= "Seleccionar Tudo";		// As in including all of the available options. Ex: "Click here to select all campaigns."
...
// Login Screen
$lang['login_amnesia_prompt']			= "Esqueceu-se da palavra-chave ou<br>do código de utente?";
$lang['login_amnesia_button']			= "Recupere-os agora";
$lang['login_email_missing']			= "Introduza o endereço email da sua conta:";
...
$lang['login_password_missing']			= "Introduza a sua Palavra-chave";
$lang['login_userid_missing']			= "Introduza o seu código de utente";
$lang['login_wrong_password']			= "A Palavra-chave introduzida não é válida.";
$lang['login_wrong_user_id']			= "O código de utente não é válido.";
...
$lang['amnesia_note_text']				= "Se não receber um email nosso dentro de poucos minutos, veja se se o nosso email não foi apanhado pelo seu filtro de Spam.
											O email será enviado de";
$lang['amnesia_password_button']		= "Envie-me a minha Palavra-chave";
$lang['amnesia_password_dir']			= "Introduza o seu código de utente em baixo, e nós enviar-lhe-emos a sua Palavra-chave para o endereço de email associado com a sua conta.";
$lang['amnesia_password_header']		= "Recuperar Palavra-chave";
$lang['amnesia_password_sent']			= "OK!<br><br>A sua Palavra-chave foi enviada<br>ao endereço de email<br>associado com a sua conta.";
...
$lang['amnesia_user_id_button']			= "Envie-me o meu<br>código de utente";
$lang['amnesia_user_id_dir']			= "Introduza o seu endereço de email em baixo, e enviar-lhe-emos todos os códigos de utentes associados com esse endereço de email:";
$lang['amnesia_user_id_header']			= "Recuperar código de utente";
$lang['amnesia_userid_sent']			= "OK!<br><br>O seu código de utente foi mandado para o endereço de email que nos deu.";

// New Account Screen
$lang['account_billing_level_1']		= /* the number 10 */ "ou menuos contas de clientes"; // ie: "This account currently has 10 or less customer accounts".
$lang['account_biz_missing']			= "Deve introduzir o nome da sua empresa."; // Usually a business name, but it could be a school or non-profit organization.
$lang['account_email_needed_1']			= "Deve introduzir um endereço de email.";
$lang['account_email_needed_2']			= "É pelo endereço de email que lhe enviaremos alertas de facturação e comunicados sobre a sua conta.";
$lang['account_enter_first']			= "Introduza o seu nome próprio.";
$lang['account_enter_last']				= "Introduza o seu apelido.";
$lang['account_id_empty']				= "Seleccione e introduza um código de utente";
$lang['account_id_exists']				= "Este código de utente já está em uso.<br>Introduza um nome differente.";
$lang['account_id_not_valid']			= "Um código de utente só pode ter letras, numeros, e _ (sublinhado)";
...
$lang['account_language_note']			= "Nota: Este é o padrão de idioma geral desta conta.<br>
											Preferência será dada á selecção de idioma do utente (definida para<br>
											cada utente desta conta na secção de utentes) ou á selecção de idioma<br>
											na página de login. ";
...
$lang['account_new_owner_id']			= "Seleccione um código de utente";
$lang['account_new_owner_restrict']		= "Máximo de 20 caracteres, sem espaços";
$lang['account_new_owner_user_id']		= "Seleccione um código de utente";
$lang['account_new_password']			= "Seleccione uma palavra-chave para sua conta.";
...
$lang['account_new_step1_dir']			= "Vamos agora proporcionar-lhe uma visita-guiada pelas seguintes quatro partes:";
...
$lang['account_new_step1_3']			= "Introduzir uma transacção de um cliente.";
$lang['account_new_step1_4']			= "Voltar para o painel de controle.";
$lang['account_referred']				= "Se alguem lhe recomendou o nosso serviço, quem foi?";
...
$lang['account_timezone_note']			= "Nota: Este é o padrão de fuso horário para esta conta.<br>
											Preferência será dada á selecção de fuso horário do utente (definida para<br>
											cada utente desta conta na secção de utentes).";
...
$lang['account_label_biz_name']			= "Nome da Empresa:";
$lang['account_label_biz_address1']		= "Endereço, 1ª linha";
$lang['account_label_biz_address2']		= "Endereço, 2ª linha";
...
$lang['cp_step_dir']					= "Aqui está no Painel de Controle, onde inicia a sessão após o login.
											Daqui podera gerir todos os aspectos da sua conta";
...
$lang['cp_campaigns_table_header_3b']	= "Transacções";	// This is the bottom line of the english phrase "Campaign Transactions"
...
// Create / Edit User
$lang['user_campaigns_header']			= "Selecione quais campanhas este utente é permitido o acesso:";
$lang['user_campaigns_admins']			= "Administradores têm acesso automático a todas campanhas";
$lang['user_edit_header']				= "Utente:";  // The Name of the user follows.
$lang['user_edit_password_label']		= "Mude a palavra-chave";
$lang['user_edit_password2_label']		= "Re-introduza a palavra-chave";
$lang['user_edit_password_note']		= "Para não mudar a palavra-chave actual, deixe estes campos vazios.";
...
$lang['user_info_sub_header']			= "Informação do utente";
$lang['user_new_header']				= "Utente novo";
$lang['user_new_id_empty']				= "Um código de utente é necessário para criar um novo utente.";
$lang['user_new_id_not_valid']			= "Um código de utente só pode ter letras, numeros, e _ (sublinhado)";
$lang['user_new_id_exists']				= "Este código de utente já está em uso.<br>Introduza um nome differente.";
$lang['user_new_no_role']				= "Tem que selecionar um papel para este utente:";
$lang['user_new_password_label']		= "Seleccione uma palavra-chave para este utente";
$lang['user_new_record_button']			= "Criar utente";
$lang['user_new_user_id_label']			= "Seleccione um código de utente";
$lang['user_restrict_20_char']			= "Não mais de que 20 caracteres";
$lang['user_role_header']				= "Papel do utente";
$lang['user_role_directions']			= "Seleccione um papel para este utente";

// Users: Common actions:
$lang['user_add_button']				= "Adicionar um utente novo";
$lang['user_delete_popup']				= "<strong>Este utente vai ser removido da lista de utentes autorizados, e arquivado.</strong><br>
											Este código de utente não poderá ser dado novamente para um novo utente.<br>
											<br>
											Para recuperar um utente arquivado, contacte-nos. Há uma taxa para este serviço.<br>
											<br>
											<strong>Tem certeza que quer eliminar este utente?</strong>";
$lang['user_delete_popup_pc']			= "Este utente vai ser removido da lista de utentes autorizados, e arquivado.\n\n
											Este código de utente não poderá ser dado novamente para um novo utente.\n\n
											Para recuperar um utente arquivado, contacte-nos. Há uma taxa para este serviço.\n\n
											Tem certeza que quer eliminar este utente?";
$lang['user_header']					= "Gestão dos utentes desta conta e suas permissões";
$lang['user_list_none']					= "Nenhum utente adicional definido.";
...
$lang['user_role_C_desc']				= "Pode gerar relatórios, ver informação sobre faturamento e campanhas,
											mas não pode ver informação sobre utentes ou clientes.";
$lang['user_role_F']					= "Empreiteiro de Fulfilment";
$lang['user_role_F_desc']				= "Dentro de campanhas autorizadas, pode só redimir prémios para clientes.";
...
$lang['user_role_K_desc']				= "Dentro de campanhas autorizadas, pode criar clientes e alterar informação deles (mas não pode mudar
											o Nº de Cartão, se já atribuído), e só pode registar ou redimir visitas de clientes (mas não removê-las).";
...
$lang['user_role_M_desc']				= "Tem acesso a tudo dentro de campanhas autorizadas, acesso a relatórios mas não a faturamento,
											e pode adicionar mas não eliminar utentes da conta.";
...
$lang['user_role_N_desc']				= "Tem acesso a tudo dentro de campanhas autorizadas, acesso a relatórios mas não a faturamento,
											não pode gerir utentes da conta ou adicionar or eliminar outras campanhas.";
$lang['user_role_O']					= "Observador";
$lang['user_role_O_desc']				= "Poder só ver informação sobre utentes e clientes e certas definições de campanhas (prémios e promoções).";
...
$lang['user_role_S_desc']				= "Pode gerir prémios e promoções dentro de campanhas autorizadas, e tambem gerir todos os aspectos dos clientes.";
...
$lang['campaign_new_created_msg']		= "<b>Parabéns.</b><br>
											<br>
											Criou uma camapanha nova.<br>
											<br>
											Em seguida, deveria personalizar a configuração desta campanha&lt;br&gt;
											baseado nas necessidades da sua empresa:";
...
$lang['campaign_new_exists']			= "O nome da campanha que introduziu já existe.<br>Seleccione um nome diferente.";
...
$lang['campaign_new_sub_header']		= "Primeiro, seleccione um tipo de campanha:";
$lang['campaign_new_type_empty']		= "Tem que escolher um tipo de campanha:";
$lang['campaign_new_buyx_desc']			= "Tal como os cartões perfurados ou carimbados que substitui, este estilo de campanha permite-lhe recompensar
											os seus clientes baseando-se no número de vezes que eles compram produtos individuais, linhas de produtos,
											ou serviços.<br>
											<br>
											Apropriado para cafés ou outros estabelecimentos comerciais que ofereçam um número limitado de produtos
											ou tipos de produtos. Encontra-se frequentemente sob a forma de cartões de papel com um certo número de
											quadrados que são perfurados ou preenchidos por carimbos de cada vez que o cliente faz uma compra, antes
											que o cliente receba um produto ou serviço gratuito. Este tipo de campanha permite-lhe fazer o mesmo, mas
											com a vantagem de não ter que imprimir cartões, e resolver questões relacionadas com cartões perdidos ou
											outras. Outra grande vantagem é que fica a saber quantos clientes tem no programa e usar a informação para
											avaliações de marketing e relatórios publicitários.</br>
											<br>
											<b>Também pode decidir quais os serviços, produtos, ou categorias de produtos e a quantidade de cada necessária
											...
											<li>Recompensar uma compra de 15kgs de farinha com um 1kg gratuito. </li>
											<li>12 pasteis de natas até que o próximo seja gratuito.</li>";

$lang['campaign_new_earn_event_desc']	= "Um hibrido entre um Cartão-Oferta (ou Cheque-Oferta) e uma campanha baseada no número de
											interacções que os clientes têm com o seu negócio. Pode recompensar
											alguém aumentando-lhe o saldo da sua conta por cada &#8220;ocorrência&#8221; (visita a uma loja,
											recomendação a outras
											pessoas, etc.) Mais tarde podera redimir o seu saldo por serviços ou produtos no seu estabelecimento.<br>
											<br>
											<b>Este tipo de programa de fidelidade permite-lhe:</b><br>
											<li>Atribuir quantos ".$lang['currency_plural']." são ganhos por cada visita ou acção</li>
											<li>Redimir qualquer quantidade do saldo total acumulado, tal como um cheque-oferta</li>
											<br>
											<b>Alguns exemplos:</b>
											...
											<li>Recompensar clientes VIP com &#8220;dinheiro de Monopólio&#8221;, só válido em compras
											dentro do estabelecimento.
											<li>Dar incentivos às crianças por ajudarem nos trabalhos domésticos.</li>";

$lang['campaign_new_event-based_desc']	= "Permite-lhe determinar recompensas baseadas no número de interacções que os clientes
											...
											distribui um certo número de cartões marcados com o mesmo numero ou código a um dos
											...
											<br>
											Uma campanha baseada em ocorrências permite-lhe:<br>
											<br>
...
$lang['campaign_new_gift_card_desc']	= "Uma campanha de Cartão-Oferta ou Cheques-Oferta permite-lhe adicionar dinheiro à conta de
											...
											onde um cartão é carregado com um certo valor em dinheiro para ser oferecido como presente
											ou para ser usado como um cartão de crédito em pré-pagamento.<br>
											<br>
											As vantagens deste programa são que <b>deixam de ser precisos os cartões de plástico</b>,
											pode ser usado em qualquer altura em que precisa de manter diferentes contas, tais como contas de bar,
											compras a prestações, semanadas das crianças, etc. O único limite é a
											sua imaginação.";
...
$lang['campaign_new_points_desc']		= "Os seus clientes acumulam pontos com base nas suas compras, pagamentos, ou promoções que forem
											defenidos. Os pontos podem ser redimidos com base em níveis pré-determinados<br>
											<br>
											Um programa de pontos, tal como os programas de milhas das companhias de aviação, permite-lhe:<br>
											<br>
											<b>Defenir a quantidade de pontos ganhos por cada ".$lang['currency']." pago. Por exemplo:</b><br>
											<li>5 pontos por ".$lang['currency']."</li>
											<li>.25 pontos por ".$lang['currency']."</li>
											<li>100 pontos por ".$lang['currency']."</li>
											<br>
											<b>Defenir vários níveis de recompensas. Por exemplo:</b><br>
											<li>1000 pontos: 50% de desconto.</li>
											<li>5000 pontos: Produto gratuito.</li>
											<li>100,000 pontos: Viagem á EuroDisney.</li>
											<br>
											<b>Atribuir promoções. Alguns exemplos:</b><br>
											<li>Pontos duplos nas Terças.</li>
											<li>500 pontos extras por ter feito uma reserva anticipada.</li>
											<li>Bonus de 25% pontos com compra de Cartão-Oferta.</li>
											<br>
											Opcionalmente, pode defenir a relação Pagamento-Recompensa que lhe deixará a possibilidade de
											redimir pontos utilizando o valor em ".$lang['currency_plural'].".";

$lang['campaign_new_name_desc']			= "Se está a criar a sua primeira campanha, dê-lhe um nome que comece com a palavra &#8220;Teste&#8221;,
											enquanto experimenta as diferentes alternativas. Poderá criar tantas campanhas quantas quizer, e parar
											ou apagar as que não quizer manter.<br>
											<br>
											Em geral, é útil usar o nome da sua empresa ou loja, se fôr curto, no nome da campanha.";
...
$lang['campaign_delete_popup']			= "<strong>Esta campanha vai ser removida da lista de campanhas e arquivada.</strong><br>
											...
											<br>
											Para recuperar uma campanha arquivada, contacte-nos. Há uma taxa para este serviço.<br>
											<br>
...
$lang['campaign_delete_popup_pc']		= "Esta campanha vai ser removida da lista de campanhas e arquivada.\n\n
											...
											Para recuperar uma campanha arquivada, contacte-nos. Há uma taxa para este serviço.\n\n
											Tem certeza que quer eliminar esta campanha?";
$lang['campaign_hide_on_hold']			= "Esconder campanhas suspendidas";
$lang['campaign_none_yet']				= "Para começar, clique no botão 'Adicionar uma campanha nova' em baixo<br>
...
$lang['campaign_view_on_hold']			= "Ver campanha suspendidas";

// Edit Campaign: Common Phrases:
$lang['edit_reward_add']				= "Adicionar um nível de prémio";
$lang['edit_reward_add_another']		= "Adicionar um outro<br>nível de prémio";
$lang['edit_reward_desc_empty']			= "Tem que fornecer uma descrição do nível de prémio.";
$lang['edit_reward_level_header']		= "Alterar nível de prémio";
$lang['edit_reward_header']				= "Níveis de prémios";
$lang['edit_reward_none']				= "Nenhum prémioNo definido ainda.";
$lang['edit_reward_table_header']		= "Descrição do prémio";

// Edit Campaign: Points
$lang['edit_points_desc_note']			= "Esta proporção pode ser mudada quando quizer, mas os pontos já acumulados pelos clientes não mudarão.";
$lang['edit_points_desc']				= "Este é um número arbitrário e pode ser qualquer coisa que faça sentido para a campanha. Por exemplo:";
$lang['edit_points_desc_header']		= $lang['Points']." ganhos por cada ".$lang['currency'];
$lang['edit_points_empty']				= "Tem que introduzir o número de ".$lang['points']." necessários para receber este prémio.";
$lang['edit_points_examples_header']	= "Alguns exemplos de prémios baseados em pontos:";
...
$lang['edit_points_ex_4_desc']			= "500ml de champô";
$lang['edit_points_ex_5_amount']		= "20";
$lang['edit_points_ex_5_desc']			= "Saco de 10kg de comida de cão";
...
$lang['edit_points_ex_8_desc']			= "Viagem à EuroDisney";
$lang['edit_points_not_valid']			= "O número de ".$lang['points']."tem que ser uma quantidade númerica.";
$lang['edit_points_profit_ratio_error']	= "Tem que introduzir um valor superior a zero<br>para activar. Deixe vazio para desactivar.";
$lang['edit_points_step_dir']			= "Define os parâmetros do seu programa de ".$lang['Points'].".";
$lang['edit_points_table_header']		= "Descrição do prémio ganho quando<br>o nível de ".$lang['points']." introduzido é atigindo.";
$lang['edit_points_too_small']			= "Introduza um valor igual ou superior a 1 ".$lang['point'].".";
...
$lang['edit_promo_desc']				= "Promoções alteram a maneira como ".$lang['points']." são ganhos.
											Pode ter promoções que adicionam ou subtraem uma quantidade específica de ".$lang['points'].",
											ou multiplicam o valor introduzido por uma determinada quantia, quando uma
											transacção é registrada. Por exemplo:";
$lang['edit_promo_edit_header']			= "Alteramento de promoção";
$lang['edit_promo_edit_error_header']	= "Precisa de introduzir um número com qual multiplicar os ".$lang['points']." ganhos.<br>
											Por exemplo:";
$lang['edit_promo_edit_error_add']		= "Precisa de introduzir um número de ".$lang['points']." para adicionar ou deduzir.<br>
											Por exemplo:<br>
...
$lang['edit_promo_ex_1_desc']			= "500 ".$lang['points']." por ter dado uma recomendação";
...
$lang['edit_promo_note_1']				= /*(Addtion Operation)*/ "promoções podem ser utilizadas por si próprias:<br>É só seleccionar a promoção e clique no botão"; /* ("record button") */
...
$lang['edit_str_header']				= "Opcional: Utilizar quantias em ".$lang['currency_plural']." para redimir ".$lang['points'];
$lang['edit_str_desc']					= "A proporção Gasto-Para-Ter-Ganho é uma das duas proporções que
											deve ter tido usar para calcular o valor em ".$lang['points']." dos seus prémios. Se a introduzir aqui,
											ligará a capacidade de redimir ".$lang['points']." utilizando um valor em ".$lang['currency_plural'].":";
$lang['edit_str_ratio_header']			= "Possibilidade de introduzir<br>montantes em ".$lang['currency_plural']."<br>para redimir ".$lang['points'].":";
...
$lang['edit_str_example_1']				= "Uma cliente quer comprar algo que custa ".$lang['currency_symbol']."100 e tem 1000 ".$lang['points']." acumulados.
											Ela pergunta se pode pagar parte da compra com os seus ".$lang['points'].".";
$lang['edit_str_example_1_desc']		= "Quando é introduzida a proporção Gasto-Para-Ter-Ganho acima, o programa <b>calcula automaticamente
											quanto ".$lang['points']." vale os ".$lang['currency_plural']." introduzidos</b>. Não há necessidade para
											si ou para os seus empregados de se lembrarem de tabelas complicadas, ou andarem sempre à procura de uma calculadora.";
...
$lang['edit_str_example_math']			= "Imagine que tenha escolhido uma proporção ".$lang['ppd']." de 5 e
											...
											para poder redimir ".$lang['currency_symbol']."10.";
...
$lang['edit_str_note_1']				= "Para desligar a possibilidade de introduzir valores em ".$lang['currency_plural']." para redimir ".$lang['points'].",
											deixe a proporção Gasto-Para-Ter-Ganho vazia e clique o botão"; /*(Set button)*/
$lang['edit_str_note_2']				= "Pode alterar a proporção Gasto-Para-Ter-Ganho como e quando quizer,
											mas os níveis dos prémios não serão mudados automaticamente.";

// Edit Campaign: Event-Based
$lang['edit_visits_empty']				= "É necessário introduzir o número de ocorrências necessárias para receber o prémio.";
$lang['edit_visits_not_valid']			= "O número de ocorrências tem que ser um número.";
$lang['edit_visits_step_dir']			= "Defina alguns níveis de prémios para a sua campanha baseada em ocorrências:";
$lang['edit_visits_table_header']		= "Número de<br>ocorrências";
$lang['edit_visits_table_header_2']		= "&nbsp;Descrição do prémio ganho quando<br>&nbsp;o número de ocorrências é atingido.";

// Edit Campaign: Dollar per Visit
$lang['edit_dpv_amount_too_small']		= "Precisa de introduzir um valor de pelo menos 1".$lang['currency_100th_symbol']." (0.01)";
...
$lang['edit_dpv_note_1']				= "Este valor pode ser alterado quando quizer, mas os ".$lang['currency_plural']." acumulados pelos seus clientes anteriormente não vão mudar.";
...
$lang['edit_buyx_item_empty']			= "Tem que introduzir um nome ou descrição deste produto ou serviço.";
...
$lang['edit_buyx_step_dir']				= "Define níveis de prémios para esta campanha:";
...
$lang['edit_giftcard_no_settings']		= "Programas de cartões-oferta não têm parâmetros ou níveis de prémios para definir.<br>(Bem, isto foi simples!)";

// Common Customer Content
$lang['customer_account_activated']		= "Conta activada";
...
$lang['customer_id_missing']			= "Nenhuma conta de cliente foi intruduzida.";
...
$lang['customer_last_activity']			= "Última actividade";  // ie: the most recent transaction for that customer.

// Manage Customer Accounts
$lang['manage_cards_delete_error']		= "Erro: Não é possível eliminar esta conta.";
$lang['manage_cards_find_by_date']		= "Data da última actividade";
...
$lang['manage_cards_popup_warning']		= "A conta deste cliente vai ser removida incluindo toda a informação e<br>
											TODA A ACTIVIDADE em todas as campanhas associadas com este cliente.<br><br>
											Note que <strong>relatórios deixaram de reflectir qualquer atividade deste cliente</strong>.<br><br>
											Esta acção NÃO PODE SER REVERSADA!<br><br>
											Tem a certeza que quer eliminar a conta deste cliente?";
$lang['manage_cards_popup_warning_pc']	= "
											A conta deste cliente vai ser removida incluindo toda a informação e\n
											TODA A ACTIVIDADE em todas as campanhas associadas com este cliente.\n\n
											Note que relatórios deixaram de reflectir qualquer atividade deste cliente.\n\n
											Esta acção NÃO PODE SER REVERSADA!\n\n
											Tem a certeza que quer eliminar a conta deste cliente?";
$lang['manage_import_campaign_name']	= "ID da campanha";
$lang['manage_import_trans_date']		= "Data da transacção";

// Manage Customer Accounts - Import Customers and Transactions
$lang['manage_import_header']			= "Importação por lote de clientes e transacções";
$lang['manage_import_customers']		= "Importar clientes por lote";
$lang['manage_import_transactions']		= "Importar transacções de clientes por lote";
...
$lang['manage_import_no_cust_data']		= "Nenhum cliente foi dado para a importação de dados.
											Copie e cole os dados de clientes no rectângulo do formulário abaixo:";
$lang['manage_import_campgn_not_valid']	= "Uma das campanhas seleccionadas não é valida.";
$lang['manage_import_select_1_campaign']= "Tem que seleccionar pelo menos uma campanha para a qual acrescentar clientes.";
$lang['manage_import_select_delimiter']	= "Seleccione um dos separadores de colunas acima.";
$lang['manage_import_new_trasns']		= /* a number */ "novas transacções acrescentadas";
$lang['manage_import_new_account']		= "conta de cliente nova";
$lang['manage_import_new_accounts']		= "contas de cliente novas";
$lang['manage_import_no_cust']			= "Nenhum cliente acrescentado ou actualizado";
$lang['manage_import_no_trans']			= "Nenhumas transacções acrescentadas";
$lang['manage_import_no_trans_data']	= "Nenhumas transacções foram dadas para a importação de dados.
											Copie e cole os dados de transacções no rectângulo do formulário abaixo:";
...
$lang['manage_import_paste_list']		= "Copie e cole a lista de clientes no rectângulo do formulário abaixo";
$lang['manage_import_trans_instrctns']	= "
											<b>Para importar uma lista de transacções:</b><br>
											<ol>
												<li style=\"padding-bottom: 5px;\">Seleccione a ordem das colunas de dados, e como cada é separada.</li>
												<li style=\"padding-bottom: 5px;\">Certifique-se de que transacções 'redimidas' têm um \"Y\"
																					na coluna \"Redimir?\" e têm <b><i>um valor POSITIVO</i></b>.</li>
												<li style=\"padding-bottom: 5px;\">Se está a importar transacções para uma campanha <b>Compre X e Ganhe Um Gratuito</b>,
																					certifique-se de que a coluna \"Item Comprado\" está seleccionada e é parte dos
												...
												<li style=\"padding-bottom: 0px;\">Copie e cole a sua lista de dados no rectângulo grande do formulário.</li>
											</ol>";
$lang['manage_import_campaign_name']	= "ID da Campanha";
$lang['manage_import_trans_date']		= "Data da transação";
$lang['manage_import_trans_amount']		= "Quantia da transação";
$lang['manage_import_redeem_event']		= "Redimir? (Y/N)";
...
$lang['manage_import_trans_list']		= "Lista de transacções";
$lang['manage_import_paste_trans']		= "Copie e cole a lista de transacções no rectângulo abaixo";
...
$lang['customer_new_demo_phone']		= "555.5555";
$lang['customer_new_demo_email']		= "ninguem@email.pt";
$lang['customer_new_demo_addtl_info']	= "Qualquer informação extra pode ser introduzida aqui.";
$lang['customer_new_id_exists']			= "O código de conta que introduziu já existe.";
...
$lang['customer_new_header']			= "Criar uma conta de cliente nova";
$lang['customer_new_multiple_matches']	= "Estas contas correspondem a dados fornecidos:";
$lang['customer_new_other_campaigns']	= "Outras campanhas<br>a quais acrescentar<br>este cliente:";
...
$lang['customer_activity_header']		= "Actividade histórica da conta";
$lang['customer_activity_none']			= "Esta conta não tem actividade.";
$lang['customer_activity_print_short']	= "Última transacção"; // As in "showing only the last recorded transaction."
...
$lang['customer_lookup_instructions']	= "Introduzir qualquer parte de informação sobre um cliente:";
...
$lang['customer_edit_add_campaigns']	= "Adicionar este client a estas campanhas:";
$lang['customer_edit_campaigns_note']	= "Adicionar um cliente a outras campanhas permite que possa ser pesquisados por qualquer parte
...
$lang['customer_edit_activity_header']	= "Actividade histórica de dados da conta";

// Record Customer Transactions
$lang['transaction_add_button']			= "Acrescentar à conta";
$lang['transaction_amount_not_valid']	= "ERRO:<br>O montante de ".$lang['currency_plural']." não é valido";
$lang['transaction_amount_too_samll']	= "ERRO:<br>O montante de ".$lang['currency_plural']." introduzido tem que ser pelo menos 0.01";
$lang['transaction_new_gc_header']		= "Adicionar ao saldo";
$lang['transaction_new_header']			= "Actividade nova";
...
$lang['transaction_purchase_label']		= "Total de compras:";
$lang['send_email']						= "Enviar e-mail?";
$lang['transactions_buyx_none']			= "Nenhums serviços ou produtos definidos.";
$lang['transactions_buyx_none_dir']		= "Volte ao painel de control e alter os parâmetros da campanha.";
$lang['transactions_visit_credited']	= "1 adicionada";
$lang['transactions_visit_redeemed']	= "deduzidas";

// Delete Customer Transaction
$lang['transaction_delete_error']		= "Erro ao eliminar esta transacção. Tente outra vez.";
$lang['transaction_delete_popup']		= "<strong>Esta transacção vai ser removida permanentemente.</strong><br><br>
											Esta acção NÃO PODE SER REVERSADA!<br><br>
											Tem a certeza que quer eliminar esta transacção?";
$lang['transaction_delete_popup_pc']	= "Esta transacção vai ser removida permanentemente..\n\n
											Esta acção NÃO PODE SER REVERSADA!\n\n
											Tem a certeza que quer eliminar esta transacção?";

// Redeem Rewards
$lang['redeem_buyx_header']				= "Tabela de prémios";
$lang['redeem_buyx_sub_header']			= "Cliente tem actividade suficiente para:";
$lang['redeem_header']					= "Prémios disponíveis";
...
$lang['redeem_points_sub_header']		= "Ou seleccione um prémio para redimir";
$lang['redeem_reward_description']		= "Descrição do prémio";
$lang['redeem_reward_balance_none']		= "Não há saldo suficiente nesta conta<br>para redimir um prémio.";
$lang['redeem_reward_balance_zero']		= "Não há saldo suficiente nesta conta<br>para deduzir qualquer valor.";
$lang['redeem_reward_balances_none']	= "Não há saldos suficientes nesta conta<br>para redimir prémios";
...
$lang['report_audit_title']				= "Relatório de fiscalização de transacções";
$lang['report_audits_all_trans']		= "Todas transacções";
$lang['report_audits_header']			= "Fiscalizações";
$lang['report_audits_redeemed_only']	= "Só redimidas";
$lang['report_audits_totals']			= "Totais";
$lang['report_balances_header']			= "Relatório de saldo de clientes";
$lang['report_balances']				= "Saldo de clientes para";
$lang['report_campaigns_included']		= "Campanhas incluídas:";
$lang['report_col_1_header']			= "Seleccione um Relatório";
$lang['report_col_2_header']			= "Seleccione um intervalo de datas";
$lang['report_col_3_header']			= "Seleccione campanha(s)";
...
$lang['report_date_range']				= "Clientes que têm um transacção entre:"; /* a range of dates.*/
...
$lang['report_marketing_freq_or_more']	= /* A given number of */ "ou mais transacções.";
$lang['report_marketing_include']		= "Incluir transacções redimidas.";
$lang['report_marketing_miss_dir_1']	= "Clientes que tiveram uma transacção entre as datas seleccionadas,";
$lang['report_marketing_miss_dir_2']	= "e não tiveram outra desde há tantos dias:";
$lang['report_missing_header']			= "Clientes sem transacções desde há"; /* a number of days.*/
...
$lang['report_no_transactions']			= "Nenhumas transações correspondem aos criterios do relatório.";
...
$lang['report_search_not_valid']		= "Tem que introduzir qualquer coisa para pesquisar.";
...
$lang['email_account_activity']			= "Actualização da sua conta";
$lang['email_activated_header']			= "Campanha activada";
$lang['email_activated_sub_header']		= "A campanha seguinte foi activada:";
$lang['email_billing_header']			= "Mudança de nível de facturação";
$lang['email_billing_from_level']		= "O nível de facturação da sua conta mudou de";
$lang['email_deactivated_header']		= "Campanha suspendida";
$lang['email_deactivated_sub_header']	= "A campanha seguinte foi suspendida:";
...
$lang['email_password_header']			= "Pedido de recuperação de palavra-chave";
$lang['email_password_dir1']			= "Pediu que nós lhe mandemos a sua palavra-chave para o utente"; /* shows the User ID */
$lang['email_password_dir2']			= "É:"; // As in "Here is the thing you requested".
$lang['email_update_header']			= "Alterações da sua conta";
$lang['email_update_sub_header']		= "Os dados da sua conta foram alterados.";
$lang['email_user_id_header']			= "Pedido de recuperação de utente";
$lang['email_user_id_sub_header_1']		= "Pediu que nós lhe mandemos o utente associado com o seu endere&ccdeil;o de email:";
$lang['email_user_id_sub_header_2']		= "Pediu que nós lhe mandemos todos os utentes associados com o seu endereço de email:"; // Plural


// Bookmarks
$lang['bookmarks_header']				= "Marcadores auto-login";
$lang['bookmarks_table_header_1']		= "Seleccione uma página";
$lang['bookmarks_table_header_2']		= "Seleccione um utente";
$lang['bookmarks_table_header_3']		= "Guarde o Marcador";
$lang['bookmarks_link_1']				= "Carregue no<br>botão direito<br>do mouse sobre<br>este link para<br>guardar o<br>marcador.";
$lang['bookmarks_link_2']				= "Clique para<br>ir à página<br>e guardar<br>o marcador<br>de lá.";
$lang['bookmarks_note']					= "Trate os links fornecidos como palavra-chaves para a sua conta, que o são.
											Recomendamos que não os envie por e-mail ou qualquer correio electrónico; em vez,
											fassa si próprio o log-in no computador onde pretende que o marcador seja utilizado e
											adicione-lo no browser à lista dos marcodores favoritos.";

// Common Error Messages:
$lang['error_balance_lookup_activity']	= /* The account id entered */ "não tem actividade.";
$lang['error_balance_lookup_no_cust']	= "Falta o código de conta de cliente.";
$lang['error_balance_lookup_no_acct']	= "Falta o código de utente da conta.";
...
$lang['error_customer_id_empty']		= "Tem que introduzir um código de utente.";
$lang['error_language_selector']		= "Há um erro com o idioma seleccionado.";
$lang['error_next_page']				= "Houve um erro ao seguir à próxima página. Tente outra vez.";
$lang['error_password_empty']			= "Tem que introduzir uma palavra-chaves.";
$lang['error_password_length']			= "A sua palavra-chave tem que ter entre 5 a 20 letras ou números.";
$lang['error_password_not_valid']		= "A sua palavra-chave só pode ser composto de letras, números, e o símbolo de sublinhado (_)";
$lang['error_password2_empty']			= "Tem que re-introduzir a palavra-chave para termos<br>
											a certeza que foi introduzida correctamente a primeira vez.";
$lang['error_passwords_no_match']		= "As palavras-pases que introduziu não correspondem. Introduza-as outra vez.";
$lang['error_phone_area_code']			= "Introduza um código telefónico válido.";
...
$lang['error_userid_error']				= "Erro: O utente que introduziu não existe.";
...
$lang['alt_campaign_place_on_hold']		= "Esta campanha está activa. Clique para suspendê-la";
$lang['alt_campaign_re-activate']		= "Clique para reactivar esta campanha";
...
$lang['alt_user_add']					= "Clique para adicionar um utente novo";
$lang['alt_user_delete']				= "Clique para eliminar este utente de maneira a não poder login ou ter acesso a esta conta";
$lang['alt_user_edit']					= "Clique para alterar os parâmetros deste utente";
...
$lang['calculator_instructions_1']		= "<strong>1) Seus clientes receberão PONTOS para cada Real gasto.
											Quantos pontos? É uma decisão arbitrária:</strong><br>
											<br>
											1 ponto para cada Real é o mais óbvio, mas não o mais indicado. Explicamos: os clientes saberão o quanto gastaram
                                 ...
                                 recomendamos usar um número aleatório que dificultará um pouco essa percepção!
                                  ...
                                  alguns arredondamentos para cima ou para baixo até o próximo ponto cheio.<br>
											<br>
											<strong>Assim que definir o número, insira-o no campo <span class=\"orangeH\">Pontos por Real</span> acima.</strong><br>";
...
$lang['transaction_email_desc']			= "Quando irá gravar uma transação, se essa cliente tem um endereço de e-mail arquivado,  será apresentado com a opção de enviar-lhe um email.";
$lang['transaction_email_instr']		= "Para personalizar os e-mails que são mandados desta campanha, encha ou altere as caixas no email-modelo, abaixo::";
$lang['transaction_email_default']		= "Obrigado pelo seu negócio e de nos ter escolhido.!";
$lang['transaction_email_incl_balance']	= "Incluir saldo";
$lang['transaction_email_incl_rewards']	= "Incluir prémios disponíveis";
...
$lang['email_agency_update_sub_header'] 			= "Informações da seguinte conta foram atualizadas:";
// Import Updates:
...
$lang['manage_import_duplicates_ignore']        = "Ignorar";
$lang['manage_import_convert_currency'] 			= "Converter os montantes transacionados para a regra da campanha?";
$lang['manage_import_trans_instrctns_2']        = 'Se está a importar <b>transações em DINHEIRO</b> para um programa baseado em pontos,
                                                  ou a importar uma lista de visitas para um programa baseado em eventos, selecione o quadrinho
                                                  "'.$lang['manage_import_convert_currency'].'"
																  Se está a importar pontos personalizados ou pontos adquiridos customizados,
																  não selecione esse quadrinho.';
// Import Undo
$lang['import_previous_title']                  = 'Importações anteriores';
$lang['Undo']                                   = 'Desfazer';
// BuyX Membership Functionality
$lang['Quantity']                               = "Quantidade";
// Mailchimp Integration:
$lang['select_a_list_to_export_to']             = "Selecione uma lista para exportar";
...
$lang['mailchimp_no_account_info']              = "Não encontramos suas informações de conta no MailChimp.
																	Introduza o sue nome de usuário e senha de MailChimp para continuar com a exportação!";
$lang['mailchimp_bad_account_info']             = "Não conferem suas informações de conta no MailChimp.
																	Introduza o sue nome de usuário e senha de MailChimp para continuar com a exportação!";
$lang['bananas']                                = "Bananas!";
$lang['no_username']                            = "Não introduziu o seu usuário e/ou senha!";
...
// API functionality
$lang['api_redeem_reward_exeeds']					= "o prêmio selecionado excede o saldo disponível";
$lang['api_redeem_amount_exeeds']					= "O valor excede o saldo disponível";
...
$lang['Campaign_Error']									= "Capanha desactivada ou invalida.";
...
$lang['user_role_I']									= "Cliente de agência c/ Importação";
$lang['user_role_I_desc']							= "Gerente que pode editar campanhas, usuários, emitir relatórios e gerenciar clientes, mas não adicionar campanhas e contas de usuário.";
$lang['user_role_G']									= "Cliente de agência";
$lang['user_role_G_desc']							= "Gerente que pode editar campanhas, usuários e emitir relatórios, mas sem poder adicionar campanhas, contas de usuário, e nem importar ou apagar clientes.";
...
$lang['DB_Timestamp']                                = "BD Timestamp";
...
$lang['edit_points_note_1_graphic']		= '<a href="http://www.stickystreet.com/calculator.php" target="_blank"><img align="right" src="graphics/calculator.gif" width="72"
...
$lang['edit_points_note_1'] 			= "Para um pouco de ajuda a calcular o valor dos ".$lang['points']." necessários para redimir um prémio, use a nossa
...
$lang['edit_points_note_2'] 			= "Para uma exposição sobre os cálculos necessários para chegar a níveis de prémios correctos, leia (em inglês)
