						...
						<div class="span12">
							...
							<div class="widget">
								<div class="widget-title">
									<h4><i class="icon-user"></i>Manage <?php echo $lang['User'];?></h4>
	...
	setSelectedIndex(document.getElementById('lang'),"<?php echo $parse_array_user_info['response']['user']['user_language'];?>");
				...
				<option value="">Need More? Contact Us.</option>
                              ...
                              <div class="form-actions">
                                 <button type="button" class="btn btn-success" onClick="submit_add_user(2)"><i class="icon-plus icon-white"></i> <?php echo $lang['nav_add'];?></button>
